    ...
    <div class="panel-body">
     ...
     <?= form_open('master/'.$aksi,'name="formsiswa" class="form-horizontal"') ?>
      <div class="form-group">
        <label class="control-label col-sm-4" >NIS<br><small style="color:red"><em>(*)</em></small><br/><?php echo form_error('nis_siswa') ?></label>
        <div class="col-sm-8">
       ...
       <div class="form-group">
        <label class="control-label col-sm-4" >Nama Lengkap<br><small style="color:red"><em>(*)</em></small><br/><?php echo form_error('nama_siswa') ?></label>
        <div class="col-sm-8">
         <input type='text' required class="form-control" name="nama_siswa" maxlength="30" value="<?php echo $nama_siswa; ?>">
        </div>
       </div>
       <div class="form-group">
        <label class="control-label col-sm-4" >Kelas<br><small style="color:red"><em>(*)</em></small><br/><?php echo form_error('kls_siswa') ?></label>
        <div class="col-sm-8">
         <input type='text' required class="form-control" name="kls_siswa" maxlength="4" value="<?php echo $kls_siswa; ?>">
        </div>
       </div>
       <div class="form-group">
        <label class="control-label col-sm-4" >Alamat<br><small style="color:red"><em>(*)</em></small><br/><?php echo form_error('alamat_siswa') ?></label>
        <div class="col-sm-8">
         <textarea required class="form-control" name="alamat_siswa"><?php echo $alamat_siswa; ?></textarea>
        </div>
       </div>
       <div class="form-group">
        <label class="control-label col-sm-4" >Nama Ayah<br><small style="color:red"><em>(*)</em></small><br/><?php echo form_error('nama_ayah_siswa') ?></label>
        <div class="col-sm-8">
         <input type='text' required class="form-control" name="nama_ayah_siswa" maxlength="35" value="<?php echo $nama_ayah_siswa; ?>">
        </div>
       </div>
       <div class="form-group">
        <label class="control-label col-sm-4" >Pendidikan Terakhir Ayah<br><small style="color:red"><em>(*)</em></small><br/><?php echo form_error('pnd_ayah_siswa') ?></label>
        <div class="col-sm-8">
       ...
       <div class="form-group">
        <label class="control-label col-sm-4" >Pekerjaan Ayah<br><small style="color:red"><em>(*)</em></small><br/><?php echo form_error('krj_ayah_siswa') ?></label>
        <div class="col-sm-8">
       ...
       <div class="form-group">
        <label class="control-label col-sm-4" >Penghasilan Orang Tua<br><small style="color:red"><em>(*)</em></small><br/><?php echo form_error('hasil_ayah_siswa') ?></label>
        <div class="col-sm-8">
         <select name="hasil_ayah_siswa" class="form-control">
             <option value="5" <?= ($hasil_ayah_siswa!=5)?:"selected" ?> >100.000 s/d 900.000</option>
             <option value="4" <?= ($hasil_ayah_siswa!=4)?:"selected" ?> >1.000.000 s/d 1.900.000</option>
             <option value="3" <?= ($hasil_ayah_siswa!=3)?:"selected" ?> >2.000.000 s/d 2.900.000</option>
             <option value="2" <?= ($hasil_ayah_siswa!=2)?:"selected" ?> >3.000.000 s/d 4.000.000</option>
             <option value="1" <?= ($hasil_ayah_siswa!=1)?:"selected" ?> > 4.000.000</option>
         </select>
        </div>
       </div>
       <div class="form-group">
        <label class="control-label col-sm-4" >Jumlah Saudara<br><small style="color:red"><em>(*)</em></small><br/><?php echo form_error('jmsdr_siswa') ?></label>
        <div class="col-sm-8">
         <input type='text' required class="form-control" name="jmsdr_siswa" maxlength="2" value="<?php echo $jmsdr_siswa; ?>">
        </div>
       </div>
       <div class="form-group">
        <label class="control-label col-sm-4" >Nilai Rata-Rata<br><small style="color:red"><em>(*)</em></small><br/><?php echo form_error('nrata_siswa') ?></label>
        <div class="col-sm-8">
         <input type='text' <?php if($aksi != 'aksiupdate') echo "required" ?> class="form-control" name="nrata_siswa" maxlength="5" value="<?= $nrata_siswa ?>">
         <?php if($aksi == 'aksiupdate'){ ?><small>Nilai tersimpan: <?php echo tr_nrata($nrata_siswa); ?></small>
         <br><small>Jika tidak ingin diubah, jangan isi kolom diatas dengan nilai.</small>
         <?php } ?>
        </div>
       </div>
       <div class="form-group">
        <label class="control-label col-sm-4" >Status Orang Tua<br><small style="color:red"><em>(*)</em></small><br/><?php echo form_error('status_siswa') ?></label>
        <div class="col-sm-8">
