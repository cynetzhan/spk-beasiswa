...
--
-- Host: 127.0.0.1
-- Generation Time: 14 Jun 2017 pada 16.34
-- Versi Server: 5.6.24
-- PHP Version: 5.6.8
...
(2, 'gurubk1', '$2y$10$q6D6n8Jds1NbFumsRSYn1uCEVsHplTMBW4W2U6PbBAF5YSoo7DoKW', '2'),
(3, 'dinas1', '$2y$10$iZzlDZd2iZ04jBQgzlAD9OW.b.qhf.Qn30LC4L25zmlNkfnQTkkLG', '3');
...
INSERT INTO `eigen_kriteria` (`id_eigen`, `id_kriteria`, `id_user`, `value_eigen`) VALUES
(1, 'JB', 1, 0.20261375560431),
(2, 'NR', 1, 0.18458456548698),
(3, 'PD', 1, 0.23981684632262),
(4, 'PH', 1, 0.16369359916055),
(5, 'PK', 1, 0.12715825622436),
(6, 'ST', 1, 0.082132977201183),
(7, 'JB', 2, 0.1547296565175),
(8, 'NR', 2, 0.21584136959584),
(9, 'PD', 2, 0.19893812980821),
(10, 'PH', 2, 0.18366020153863),
(11, 'PK', 2, 0.1070538519883),
(12, 'ST', 2, 0.13977679055152);
...
INSERT INTO `pair_kriteria` (`id_pair`, `id_kriteria`, `id_kriteria_pair`, `id_user`, `value`) VALUES
(1, 'JB', 'JB', 1, 1),
(2, 'JB', 'NR', 1, 1),
(3, 'JB', 'PD', 1, 0.33333333333333),
(4, 'JB', 'PH', 1, 2),
(5, 'JB', 'PK', 1, 3),
(6, 'JB', 'ST', 1, 2),
(7, 'NR', 'JB', 1, 1),
...
(30, 'PK', 'ST', 1, 2),
(31, 'ST', 'JB', 1, 0.5),
(32, 'ST', 'NR', 1, 0.33333333333333),
(33, 'ST', 'PD', 1, 0.33333333333333),
(34, 'ST', 'PH', 1, 1),
(35, 'ST', 'PK', 1, 0.5),
(36, 'ST', 'ST', 1, 1),
(37, 'JB', 'JB', 2, 1),
...
(59, 'PH', 'PK', 2, 0.5),
(60, 'PH', 'ST', 2, 1),
(61, 'PK', 'JB', 2, 0.33333333333333),
(62, 'PK', 'NR', 2, 0.33333333333333),
(63, 'PK', 'PD', 2, 0.5),
(64, 'PK', 'PH', 2, 2),
(65, 'PK', 'PK', 2, 1),
(66, 'PK', 'ST', 2, 0),
...
--
ALTER TABLE `eigen_kriteria`
  MODIFY `id_eigen` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=13;
--
...
--
ALTER TABLE `pair_kriteria`
  MODIFY `id_pair` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=73;
--
